...
public class MethodJavadoc extends Javadoc {
    ...
    public static MethodJavadoc.Builder builder() {
        return new MethodJavadoc.Builder();
    }

    public static class Builder extends AbstractJavadocBuilder<MethodJavadoc.Builder> {
